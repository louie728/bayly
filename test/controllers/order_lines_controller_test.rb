...
class OrderLinesControllerTest < ActionController::TestCase
  ...
  test "should create order_line" do
    assert_difference('OrderLine.count') do
      post :create, order_line: { item_id: @order_line.item_id, note: @order_line.note, order_id: @order_line.order_id, price_in_cents: @order_line.price_in_cents, qty: @order_line.qty, status: @order_line.status }
    end
  ...
  test "should update order_line" do
    patch :update, id: @order_line, order_line: { item_id: @order_line.item_id, note: @order_line.note, order_id: @order_line.order_id, price_in_cents: @order_line.price_in_cents, qty: @order_line.qty, status: @order_line.status }
    assert_redirected_to order_line_path(assigns(:order_line))
  end
